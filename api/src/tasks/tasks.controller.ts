...
import {ApiBearerAuth, ApiCreatedResponse, ApiHeader, ApiOkResponse, ApiSecurity, ApiTags} from "@nestjs/swagger";
...
export class TasksController {
  ...
  @Get(':id')
  @ApiCreatedResponse({type:TaskEntity})
  async findOne(@Param('id') id: string,@ActiveUser() activeUser: ActiveUserData) {
    try{
  ...
  @Patch(':id')
  @ApiCreatedResponse({type:TaskEntity})
  async update(@Param('id') id: string, @Body() updateTaskDto: UpdateTaskDto,@ActiveUser() activeUser: ActiveUserData) {
    try {
